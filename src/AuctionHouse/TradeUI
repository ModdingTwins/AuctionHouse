...
use AuctionHouse\Commands\Ah;
use AuctionHouse\Commands\Cart;
use AuctionHouse\Commands\MyOffers;
//use AuctionHouse\Commands\Sell;
use AuctionHouse\UIForms\CustomForm;
use AuctionHouse\UIForms\SimpleForm;
use AuctionHouse\EconomyProvider\EconomyProvider;
use AuctionHouse\EconomyProvider\EconomySProvider;
...
class AuctionHouse extends PluginBase{
	...
	public function setEconomyProvider(EconomyProvider $provider){
        ...
        public function getBuyOrSellForm(Player $player) {
                ...
                $form->setTitle(RandomUtils::colorMessage("&e&k|&r&5&lAuctionHouse&r&k&e|"));
                $content = "";
